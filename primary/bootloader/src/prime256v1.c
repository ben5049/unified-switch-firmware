...
const uint8_t prime256v1_Prime[ECDSA_SIZE] = {
...
const uint32_t prime256v1_Prime_len = ECDSA_SIZE;

const uint8_t prime256v1_A[ECDSA_SIZE] = {
    /*0x00,*/ 0xff, 0xff, 0xff, 0xff, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
    0xff, 0xff, 0xfc};

/* PKA operation need abs(a) */
const uint8_t prime256v1_absA[ECDSA_SIZE] = {
    /*0x00,*/ 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x03};

const uint32_t prime256v1_A_len = ECDSA_SIZE;

/* PKA operation need the sign of A */
const uint32_t prime256v1_A_sign = 1;

const uint8_t prime256v1_B[ECDSA_SIZE] = {
...
const uint32_t prime256v1_B_len = ECDSA_SIZE;
...
const uint32_t prime256v1_GeneratorX_len = ECDSA_SIZE;

/* This buffer is extracted from prime256v1_Generator as its second part */
const uint8_t prime256v1_GeneratorY[ECDSA_SIZE] = {
    0x4f, 0xe3, 0x42, 0xe2, 0xfe, 0x1a, 0x7f, 0x9b, 0x8e, 0xe7, 0xeb, 0x4a, 0x7c, 0x0f, 0x9e,
    0x16, 0x2b, 0xce, 0x33, 0x57, 0x6b, 0x31, 0x5e, 0xce, 0xcb, 0xb6, 0x40, 0x68, 0x37, 0xbf,
    0x51, 0xf5};

const uint32_t prime256v1_GeneratorY_len = ECDSA_SIZE;

const uint8_t prime256v1_Order[ECDSA_SIZE] = {
...
const uint32_t prime256v1_Order_len = ECDSA_SIZE;
